...
export default function AdminDashboard() {
  ...
  const fetchAllAdminData = async () => {
    setLoading(true);
    try {
      const API_BASE = 'https://eaqari.vercel.app/api';
      const results = await Promise.all([
        safeFetch(`${API_BASE}/admin/users`),
        safeFetch(`${API_BASE}/properties?admin_view=true`),
        safeFetch(`${API_BASE}/admin/reports`),
        safeFetch(`${API_BASE}/admin/verifications`),
        safeFetch(`${API_BASE}/admin/conversations`),
  ...
  const handleBanUser = async (id: number, currentStatus: string) => {
    ...
    try {
      ...
      const res = await safeFetch(`https://eaqari.vercel.app/api/admin/users/${id}/${endpoint}`, { method: 'PUT' });
      if (res.ok) {
  ...
  const handleDeleteUser = async (id: number) => {
    ...
    try {
      const res = await safeFetch(`https://eaqari.vercel.app/api/admin/users/${id}`, { method: 'DELETE' });
      if (res.ok) {
  ...
  const handleUpdateUser = async () => {
    ...
    try {
      const res = await fetch(`https://eaqari.vercel.app/api/admin/users/${editingUser.id}`, {
        method: 'PUT',
  ...
  const handlePropertyStatus = async (id: number, status: string) => {
    ...
    try {
      const res = await fetch(`https://eaqari.vercel.app/api/properties/${id}/status`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleDeleteProperty = async (id: number) => {
    ...
    try {
      const res = await safeFetch(`https://eaqari.vercel.app/api/admin/properties/${id}`, { method: 'DELETE' });
      if (res.ok) {
  ...
  const handleToggleFeatured = async (id: number) => {
    try {
      const res = await safeFetch(`https://eaqari.vercel.app/api/admin/properties/${id}/toggle-featured`, { method: 'PUT' });
      if (res.ok) {
  ...
  const handleBulkStatus = async (status: string) => {
    ...
    try {
      const res = await fetch('https://eaqari.vercel.app/api/admin/properties/bulk-status', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleResolveReport = async (reportId: number, newStatus: string, notes?: string) => {
    try {
      const res = await fetch(`https://eaqari.vercel.app/api/admin/reports/${reportId}`, {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleApproveVerification = async (id: number) => {
    try {
      const res = await safeFetch(`https://eaqari.vercel.app/api/admin/verifications/${id}/approve`, { method: 'PUT' });
      if (res.ok) {
        const data = await safeJson(res, {});
  ...
  const handleRejectVerification = async (id: number) => {
    try {
      const res = await safeFetch(`https://eaqari.vercel.app/api/admin/verifications/${id}/reject`, { method: 'PUT' });
      if (res.ok) {
        const data = await safeJson(res, {});
  ...
  const handleSendNotification = async () => {
    ...
    try {
      await fetch('https://eaqari.vercel.app/api/notifications/admin/send', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleWipeAll = async () => {
    ...
    setWipeLoading(true);
    try {
      const res = await fetch('https://eaqari.vercel.app/api/admin/properties/wipe/all', {
        method: 'DELETE',
        headers: { 'Content-Type': 'application/json' },
